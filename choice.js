  ...
  WeightedList: (function () {
    function _WeightedList(initial) {
      ...
      if (Array.isArray(initial)) {
        ...
        throw new Error(`Unknown object "${initial.toString()}" passed to WeightedList constructor! (Expected array or nothing)`);
      }
    }
    ...
    _WeightedList.prototype = {
      ...
      _buildWeightedHeap() {
        let items = [];
        for (let key in this.weights) if (this.weights.hasOwnProperty(key)) {
